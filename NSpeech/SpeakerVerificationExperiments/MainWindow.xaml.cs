...
namespace SpeakerVerificationExperiments
{
    ...
    public sealed partial class MainWindow: INotifyPropertyChanged
    {
        ...
        private VoiceKey VqCodeBook { get; set; }
        ...
        private VoiceFeature _selectedFeature = VoiceFeature.Pitch;
...
//        }
        ...
        {
            _uesdAlgorithm = UsedQuatizationAlgorithm.Lbg;//LOL :)
        }
